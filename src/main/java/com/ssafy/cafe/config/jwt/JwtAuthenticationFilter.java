...
//            }
            ...
            UsernamePasswordAuthenticationToken token = new UsernamePasswordAuthenticationToken(user.getId(), user.getPass());
...
//            System.out.println(request.getInputStream().toString()); // 이게 유저아이디(이름)와 패스워드 가 담겨있다
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws IOException, ServletException {
        ...
        String jwtToken= JWT.create()
                ...
                .withExpiresAt(new Date(System.currentTimeMillis()+(60000*120)))//만료 시간 60000 이 1분
